...
## 🎯 Career Objective
Entry-level QA Tester with strong knowledge of **Manual and Automation Testing**,
Selenium WebDriver, Java, TestNG, and Cucumber. Seeking a QA role to contribute
to software quality and automation initiatives.

---

## 🎓 Education
🏫 **B.Sc Computer Technology** (2022 - 2025)
...
### 🧪 Testing Types
![Manual Testing](https://img.shields.io/badge/Manual_Testing-orange?style=flat-square)
![Automation Testing](https://img.shields.io/badge/Automation_Testing-orange?style=flat-square)
![Regression Testing](https://img.shields.io/badge/Regression_Testing-orange?style=flat-square)
![Smoke Testing](https://img.shields.io/badge/Smoke_Testing-orange?style=flat-square)
![Sanity Testing](https://img.shields.io/badge/Sanity_Testing-orange?style=flat-square)

### 🤖 Automation Tools
![Selenium](https://img.shields.io/badge/Selenium-WebDriver-43B02A?style=flat-square&logo=selenium)
![TestNG](https://img.shields.io/badge/TestNG-red?style=flat-square)
...
### 👨‍💻 Programming
![Java](https://img.shields.io/badge/Java-Core-ED8B00?style=flat-square&logo=java)
...
### 🌐 Web Application Test Automation – Selenium WebDriver
| Detail | Info |
|--------|------|
| 🛠 Tools | Selenium WebDriver, Java, Cucumber BDD, Maven |
| 🏗 Pattern | Page Object Model (POM) |
| 📋 Framework | TestNG / JUnit |

- ✅ Automated login, product selection, cart, and checkout workflows
- ✅ Implemented reusable **PageFactory** classes
- ✅ Configured **Maven** execution and reporting
- ✅ Followed **BDD approach** with Cucumber feature files
...
## 📜 Certifications
🏆 **Software Testing** - Manual & Automation using Java
🏫 Refinement Software Solution

---

## 🌐 Languages
![English](https://img.shields.io/badge/English-Professional-blue?style=flat-square)
![Tamil](https://img.shields.io/badge/Tamil-Native-orange?style=flat-square)
